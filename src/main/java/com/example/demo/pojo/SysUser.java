...
11：其它
	...
	public String toString() {
		return "SysUser [id=" + id + ", username=" + username + ", password=" + password + ", nickname=" + nickname
				+ ", age=" + age + ", sex=" + sex + ", job=" + job + ", faceImage=" + faceImage + ", province="
				+ province + ", city=" + city + ", district=" + district + ", address=" + address + ", authSalt="
				+ authSalt + ", lastLoginIp=" + lastLoginIp + ", lastLoginTime=" + lastLoginTime + ", isDelete="
				+ isDelete + ", registTime=" + registTime + "]";
	}
